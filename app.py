...
VERSION = "0.4.0"  # adds /config runtime settings
...
STATIC_DIR = pathlib.Path(os.getenv("STATIC_DIR") or str(resource_path("static")))
...
def serve_index():
    # Prefer bundle root index.html, otherwise show a tiny help page.
...
# import os, csv, time, hashlib, pathlib, math, re, string, json, glob, random, sys
...
# # Public-domain statistical dampener
# PD_FINGERPRINT_DIR = os.getenv("PD_FINGERPRINT_DIR") or str(resource_path("pd_fingerprints"))
# PD_NGRAM_N = int(os.getenv("PD_NGRAM_N", "5"))
# PD_DAMP_THRESHOLD = float(os.getenv("PD_DAMP_THRESHOLD", "0.12"))
# PD_MAX_CONF = float(os.getenv("PD_MAX_CONF", "0.25"))
...
# def pd_write_dir() -> pathlib.Path:
#     d = user_data_dir() / "pd_fingerprints"
#     d.mkdir(parents=True, exist_ok=True)
#     return d

# def centroids_write_dir() -> pathlib.Path:
#     d = user_data_dir() / "model_centroids"
#     d.mkdir(parents=True, exist_ok=True)
#     return d
...
# )
# STATIC_DIR = os.getenv("STATIC_DIR") or str(resource_path("static"))
...
# MODEL_CENTROID_DIR = os.getenv("MODEL_CENTROID_DIR") or str(resource_path("model_centroids"))
# FPRINT_MIN_TOKENS = int(os.getenv("FPRINT_MIN_TOKENS", "180"))
